...
public class Demo extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6606760486324695743L;
	Editor editor;
	...
	public Demo() {
		...
		this.getContentPane().add(new JButton(new OpenAction("Open Document")),
				BorderLayout.NORTH);
	...
	private class OpenAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 2052786768210611255L;
