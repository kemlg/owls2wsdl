...
class JavaHighlightStrategy extends HighlightStrategy {
	...
	public JavaHighlightStrategy(SyntaxDocument doc) {
		...
		StyleConstants.setForeground(blockCommentAttributes, new Color(0, 128,
				0));
		...
		StyleConstants.setForeground(lineCommentAttributes,
				new Color(0, 192, 0));
		...
		StyleConstants.setForeground(characterLiteralAttributes,
				Color.lightGray);
		...
		addAttributeSetForToken(LineCommentTokenType.class,
				lineCommentAttributes);
		...
		addAttributeSetForToken(StringLiteralTokenType.class,
				stringLiteralAttributes);
		addAttributeSetForToken(CharacterLiteralTokenType.class,
				characterLiteralAttributes);
