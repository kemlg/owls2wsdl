...
public class DefaultTokenFactory extends AbstractTokenFactory {
	...
	private static String keywords[] = { "boolean", "byte", "catch", "char",
			"class", "continue", "default", "double", "else", "extends",
			"false", "final", "float", "for", "if", "import", "implements",
			"instanceof", "int", "interface", "new", "package", "private",
			"public", "return", "static", "synchronized", "this", "throw",
			"throws", "true", "try", "void", "volatile", "while" };

	private static TreeSet<String> keywordSet;

	static {
		keywordSet = new TreeSet<String>();
