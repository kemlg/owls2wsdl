...
public class WSDLBuilderHelper {
	...
	public String extractContext(String supportedByString) {
		...
		if (supportedByString.substring(index + 1).toLowerCase()
				.equals("service")) {
	...
	public static void main(String[] args) {
		...
		System.out.println("Kontext    : "
				+ helper.extractContext("BOOK_PRICE_SERVICE"));
		System.out.println("ServiceName: "
				+ helper.reformatOWLSSupportedByString("ZipCodeFinderService"));
		System.out
				.println("ServiceName: "
						+ helper.reformatOWLSSupportedByString("_STUDENTINFORMATION_BLAH_BLUB_SERVICE"));
	}
