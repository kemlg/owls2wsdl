...
public class AbstractServiceMapper {
	...
	public void mapAbstractServiceCollection(
			AbstractServiceCollection serviceCollection, OutputStream out,
			boolean prettyprint) {
		try {
			Mapping mapping = new Mapping();
			String mapping_file = "castor-mapping.xml";
	...
	public void saveAbstractServiceCollection(
			AbstractServiceCollection serviceCollection, String path) {
		try {
			Mapping mapping = new Mapping();
			String mapping_file = "castor-mapping.xml";
			mapping.loadMapping(this.getClass().getResource(mapping_file)
	...
	public AbstractServiceCollection loadAbstractServiceCollection(File file) {
		...
		try {
			...
			Unmarshaller unmarshaller = new Unmarshaller(
					AbstractServiceCollection.class);
