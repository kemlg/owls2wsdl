...
public class AbstractDatatypeMapper {
	...
	public void mapAbstractDatatypeKB(AbstractDatatypeKBData kb_data,
	...
	public void importAbstractDatatypeKB(File file) {
		try {
			...
			AbstractDatatypeKBData newdata = (AbstractDatatypeKBData) unmarshaller
					.unmarshal(reader);
			AbstractDatatypeKB.getInstance().getAbstractDatatypeKBData()
					.importDatatypes(newdata);
		} catch (Throwable t) {
			t.printStackTrace();
		}
	}
	...
	public static void main(String[] args) {
		...
		AbstractDatatypeMapper.getInstance().loadAbstractDatatypeKB(
				"file:/D:/tmp/AbstractDatatypesKB2.xml");
