...
public class ServiceOverviewPanel extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4309466305504699089L;
	private ServiceListModel serviceListModel;
	private JList<AbstractService> serviceList;
	...
	private void initComponents() {
		...
		loadButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// serviceListModel.addToModel("file:///D:/htw_kim/thesis/OWLS-MX/owls-tc2/domains/1.1/travel/");
				// //_warmfront_Italyservice.owls");
				serviceList.updateUI();
				// serviceList.revalidate();
				System.out.println("SIZE OF MODEL: "
						+ serviceListModel.getSize());
			}
		});
						...
						System.out.println(">>>> "
								+ ((ServiceListModel) serviceList.getModel())
										.getElementAt(serviceList
												.getSelectedIndex()));
						// detailViewPanel.updatePanel(
						// ((ServiceListModel)serviceList.getModel()).getAbstractServiceAt(serviceList.getSelectedIndex())
						// );
