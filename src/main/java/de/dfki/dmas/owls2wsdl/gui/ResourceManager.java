...
/**
 * Mappt Namen von Buttons, Labels usw. auf Icons, Beschriftungen etc, die in
 * Properties-Datei festgehalten sind.
 */
public final class ResourceManager {
	 ...
	 *            unser Basename
	 */
	public final static void setBundle(String baseName, String language,
			String country) {
		System.out.println("[.] Trying to load Property-File:" + baseName + "_"
				+ language + "_" + country + ".properties");
		resourceBundle = (PropertyResourceBundle) ResourceBundle.getBundle(
				baseName, new Locale(language, country),
				ResourceManager.class.getClassLoader());
		System.out.println("[.] resourceBundle: " + resourceBundle.toString());
	}

	public final static void setDefaultBundle(String baseName, String language,
			String country) {
		System.out.println("[.] Trying to load default Property-File:"
				+ baseName + "_" + language + "_" + country + ".properties");
		defaultBundle = (PropertyResourceBundle) ResourceBundle.getBundle(
				baseName, new Locale(language, country),
				ResourceManager.class.getClassLoader());
	}

	/**
	 * Gibt das Bundle zur�ck
	 * 
	 * @return das Bundle-Objekt
	 */
	public final static PropertyResourceBundle getBundle() {
		if (resourceBundle == null) {
			setBundle("de.dfki.dmas.owls2wsdl.gui.OWLS2WSDL", Locale
	...
	public final static Enumeration<String> getKeys() {
	...
	public final static void printResources() {
		Enumeration<String> resources = getKeys();
	...
	public static void main(String args[]) {
		ResourceManager.setBundle("de.dfki.dmas.owls2wsdl.gui.OWLS2WSDL", "de",
				"DE");
		int i = 0;
		Enumeration<String> e = ResourceManager.getKeys();
