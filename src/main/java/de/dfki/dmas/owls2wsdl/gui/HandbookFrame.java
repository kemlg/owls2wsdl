...
public class HandbookFrame extends javax.swing.JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7958449329660265895L;

	/** Creates new form HandbookFrame */
	public HandbookFrame(String handbookUrlString, String path2Icon) {
		URL imageUrl = OWLS2WSDLGui.class.getClassLoader().getResource(
				path2Icon);
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(
				...
				org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 415,
				Short.MAX_VALUE));
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					new HandbookFrame(heb.getHandbookIndexURL().toString(),
							"images/owls2wsdl_icon.gif").setVisible(true);
				} catch (MalformedURLException murle) {
	...
	// URL hb_index = new
	// URL("http://owls2wsdl.googlecode.com/svn/trunk/handbook/index.html");
	// BufferedReader in = new BufferedReader( new
	// InputStreamReader(hb_index.openStream()));
	//
	// String inputLine;
	//
