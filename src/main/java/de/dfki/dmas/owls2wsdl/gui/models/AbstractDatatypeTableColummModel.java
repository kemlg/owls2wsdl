...
public class AbstractDatatypeTableColummModel extends DefaultTableColumnModel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 416236280337179308L;

	public static final String[] COLHEADS = { "Name", "OWL", "Class/Type",
			"Inherited by", "XSD", "Depth", "Use?" };

	/**
	 * set prefered column widths
	 */
	public static final int[] COLHEADWIDTHS = { 140, 35, 140, 140, 60, 35, 35 };
