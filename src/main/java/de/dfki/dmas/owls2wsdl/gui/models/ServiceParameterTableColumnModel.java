...
public class ServiceParameterTableColumnModel extends DefaultTableColumnModel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2109600079015010032L;

	public static final String[] COLHEADS = { "Direction", "Pos", "ID", "Type",
			"in KB", "Valid" };

	public static final int[] COLHEADWIDTHS = { 50, 10, 100, 310, 40, 40 };
