...
public class MenuBarView {
	...
	final URL importMenuIconURL = ToolBar.class
			.getResource("/images/16x16etool/import_wiz.gif");
	final URL exportMenuIconURL = ToolBar.class
			.getResource("/images/16x16etool/export_wiz.gif");
	final URL saveMenuIconURL = ToolBar.class
			.getResource("/images/16x16etool/save_edit.gif");
	final URL saveAllMenuIconURL = ToolBar.class
			.getResource("/images/16x16etool/saveall_edit.gif");
	final URL loadAdd2KBIconURL = ToolBar.class
			.getResource("/images/16x16/addrepo_rep.gif");
	final URL helpMenuIconURL = ToolBar.class
			.getResource("/images/16x16etool/help_contents.gif");
	final URL resDocPropURL = ToolBar.class
			.getResource("/images/16x16/actions/document-properties.png");
	final URL resExitURL = ToolBar.class
			.getResource("/images/16x16/actions/system-log-out.png");
	...
	private JMenu buildFileMenu() {
		...
		JMenu menu = createMenu(ResourceManager.getString("menubar.file"),
				ResourceManager.getString("menubar.file_mm").charAt(0));

		item = createMenuItem(ResourceManager.getString("project.new"),
		...
		item = createMenuItem(ResourceManager.getString("project.open"),
		...
		item = createMenuItem(ResourceManager.getString("project.save"),
		...
		item = createMenuItem(ResourceManager.getString("project.types.load"),
				loadAdd2KBIcon);
		item.setActionCommand(GUIActionListener.LOAD_TYPE_INFORMATION);
		menu.add(item);

		item = createMenuItem(ResourceManager.getString("project.types.save"),
				saveMenuIcon);
		...
		if (!isQuitInOSMenu()) {
			item = createMenuItem(ResourceManager.getString("closing.cmd"),
					iconExit, ResourceManager.getString("closing.cmd_mm")
							.charAt(0));
	...
	private JMenu buildEditMenu() {
		JMenu menu = createMenu(ResourceManager.getString("menubar.edit"),
				ResourceManager.getString("menubar.edit_mm").charAt(0));

		JMenuItem item;
		/*
		 * item = createMenuItem("Copy", 'C', KeyStroke.getKeyStroke("ctrl C"));
		 * menu.add(item); item = createMenuItem("Paste", 'P',
		 * KeyStroke.getKeyStroke("ctrl P")); menu.add(item);
		 * 
		 * menu.addSeparator();
		 */
		item = createMenuItem(ResourceManager
				.getString("menubar.edit.types.remove.selected"));
		item.setActionCommand(GUIActionListener.REMOVE_SELECTED_DATATYPE);
		menu.add(item);

		item = createMenuItem(ResourceManager
				.getString("menubar.edit.types.remove.all"));
		item.setActionCommand(GUIActionListener.REMOVE_ALL_DATATYPES);
		menu.add(item);

		item = createMenuItem(ResourceManager
				.getString("menubar.edit.types.remove.unreferenced"));
		...
		item = createMenuItem(ResourceManager
				.getString("menubar.edit.services.remove.selected"));
		item.setActionCommand(GUIActionListener.REMOVE_SELECTED_SERVICES);
		menu.add(item);

		item = createMenuItem(ResourceManager
				.getString("menubar.edit.services.remove.all"));
		...
		item = createMenuItem(ResourceManager
				.getString("menubar.edit.services.select.all"));
		...
		item = createMenuItem(ResourceManager
				.getString("menubar.edit.project.setname"));
	...
	private JMenu buildViewMenu() {
		JMenu menu = createMenu(ResourceManager.getString("menubar.view"),
				ResourceManager.getString("menubar.view_mm").charAt(0));

		switch2DatatypeDetailsItem = createMenuItem(ResourceManager
				.getString("menubar.view.details.types"));
		switch2DatatypeDetailsItem
				.setActionCommand(GUIActionListener.SHOW_DATATYPEDETAILS);
		menu.add(switch2DatatypeDetailsItem);

		switch2ServiceDetailsItem = createMenuItem(ResourceManager
				.getString("menubar.view.details.services"));
		switch2ServiceDetailsItem
				.setActionCommand(GUIActionListener.SHOW_SERVICEDETAILS);
		menu.add(switch2ServiceDetailsItem);

		menu.addSeparator();

		switch2ProjectDetailsItem = createMenuItem(ResourceManager
				.getString("menubar.view.details.project"));
		switch2ProjectDetailsItem
				.setActionCommand(GUIActionListener.SHOW_PROJECTDETAILS);
		menu.add(switch2ProjectDetailsItem);

		menu.addSeparator();

		JMenuItem item = createMenuItem(ResourceManager
				.getString("menubar.view.update"));
	...
	private JMenu buildExtrasMenu() {
		JMenu menu = createMenu(ResourceManager.getString("menubar.extras"),
		...
		item = createMenuItem(
				...
				iconProperties,
				ResourceManager.getString("menubar.extras.properties_mm")
						.charAt(0), KeyStroke.getKeyStroke("ctrl shift P"));
	...
	private JMenu buildHelpMenu() {
		JMenu menu = createMenu(ResourceManager.getString("menubar.help"),
		...
		if (!isAboutInOSMenu()) {
			...
			item = createMenuItem(
					...
					ResourceManager.getString("menubar.help.about_mm")
							.charAt(0));
			item.addActionListener(this.actionListener);
