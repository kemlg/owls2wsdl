...
/**
 * The <code>LongestCommonSubstring</code> class houses a single method for
 * finding the longest common substring of two string inputs.
 * <p>
 * Extensions to this class for finding common substrings for an array, list, or
 * collection of strings are trivial.
 * <p>
 * This implementation is inspired by Jon Bently's Programming Pearls. See: <br/>
 * <code>http://www.cs.bell-labs.com/cm/cs/pearls/sec152.html</code> for more
 * detail.
 * <p>
 * NO EXPLICIT DUPLICATE DETECTION PERFORMED! In other words, if you have two
 * equally long substrings that occur, we break the tie by returning the
 * lexicographically smaller one. For example, this class handles duplicates in
 * the following way:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * The "smaller" substring is returned; thus, 'o' is favored over 'x' and 'a' is
 * favored over 'c'.
 * <p>
 * If you want to gather the whole collection of equal-length longest common
 * substrings, then you need to alter the method below to return a Vector,
 * Array, or ArrayList of such strings.
 * 
