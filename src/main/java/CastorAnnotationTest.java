 ...
 * <a
 * href="http://jira.codehaus.org/browse/CASTOR-1895">http://jira.codehaus.org
 * /browse/CASTOR-1895</a><br />
 * <a href="http://www.castor.org/release-notes.html">http://www.castor.org/
...
public class CastorAnnotationTest {
	...
	public static void main(String[] args) {
		...
		while (docEnumeration.hasMoreElements()) {
			System.out.println("- " + docEnumeration.nextElement().getSource());
		}
	}
}
